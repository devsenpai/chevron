                        ...
                        <div class="row">
                            <div class="col-lg-12 m-b30">
                                ...
                                <ul>
                                    ...
                                    <li>Upload proof of letter of admission and school ID card</li>
                                    <li>Upload proof of SSCE or Equivalent Certificate</li>
                                    <li>Upload proof of JAMB Result</li>
                                    <li>Upload proof of Admission letter from the University and Matriculation Number</li>
